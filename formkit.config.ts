    ...
    config: {
        classes: generateClasses({
            global: {
                outer: 'mb-4',
                inner: 'relative',
                input: 'input pl-12 w-full bg-zinc-100 formkit-invalid:border-red-500 formkit-invalid:outline-red-500' +
                    ' formkit-invalid:border-2 formkit-invalid:bg-red-50/50',
                message: 'formkit-invalid:text-red-500 text-sm',
                label: 'font-semibold',
